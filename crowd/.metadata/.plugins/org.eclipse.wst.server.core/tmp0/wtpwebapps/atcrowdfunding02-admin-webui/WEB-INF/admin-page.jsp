...
<script type="text/javascript" src="crowd/my-admin.js"></script>
<script type="text/javascript">
	...
	function initPagination() {
		...
		var properties = {
			...
			items_per_page : parseInt('${requestScope.pageInfo.pageSize}'),// 每页显示 1 项 
			current_page : parseInt('${requestScope.pageInfo.pageNum - 1}'),
	...
	$(function(){
		...
		$("#removeAdminBtn").click(function(){
			...
			$.ajax({
				"url":"admin/delete/by/id/list.json",
				"type":"post",
				"data":requestBody,
							...
							<table class="table  table-bordered">
								...
								<tbody>
									<c:if test="${empty requestScope.pageInfo.list }">
										<tr>
											<td colspan="6" align="center">抱歉！没有找到您所搜索的相关数据！</td>
										</tr>
									</c:if>
									<c:if test="${!empty requestScope.pageInfo.list }">
										<c:forEach items="${requestScope.pageInfo.list }" var="admin"
											...
											<tr>
												...
												<td style="color: red;">${admin.userName }</td>
												<td>${admin.email }</td>
												<td>
...
<%@include file="/WEB-INF/modal-admin-remove.jsp"%>
</html>
