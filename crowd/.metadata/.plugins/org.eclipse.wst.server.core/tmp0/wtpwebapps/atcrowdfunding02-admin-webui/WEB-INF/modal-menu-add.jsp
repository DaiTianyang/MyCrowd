		...
		<div class="modal-content">
			...
			<form>
				...
				<div class="modal-footer">
					<button id="resetMenuBtn" type="reset" class="btn btn-default"><i class="glyphicon glyphicon-refresh"></i> 重置</button>
					<button id="addMenuBtn" type="button" class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i> 保存</button>
				</div>
			</form>
		</div>
	</div>
