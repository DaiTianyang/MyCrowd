...
<script type="text/javascript">
	$(function() {
		$("#toRightBtn").click(function() {
			...
			//:eq(1)表示选择页面上的第二个
			//>表示查找他的子元素
			//selected表示查找被选中的option
			//appendTo能将指定元素追加到指定位置
						...
						<form action="assign/do/role/assign.html" method="post"
							...
							<div class="form-group">
								<label for="exampleInputPassword1">未分配角色列表</label><br> <select
									...
									<!-- <option value="角色的id">浏览器页面用户看到的数据--角色名</option> -->
							...
							<!-- 给保存按钮添加单击相应函数，使其在点击时能够选中全部的option -->
							<button id="submitBtn" type="submit"
								style="width: 330px; position: relative; top: 6px;"
