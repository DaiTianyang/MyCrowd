 ...
 * Generated at: 2020-09-23 04:20:13 UTC
...
public final class admin_002dadd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t<label for=\"exampleInputPassword1\">登录账号</label> \r\n");
      out.write("\t\t\t\t\t\t\t\t<input\r\n");
      out.write("\t\t\t\t\t\t\t\t\tname=\"loginAcct\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\ttype=\"text\" class=\"form-control\" id=\"exampleInputPassword1\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tplaceholder=\"请输入登录账号\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<label for=\"exampleInputPassword1\">登录密码</label> \r\n");
      out.write("\t\t\t\t\t\t\t\t<input\r\n");
      out.write("\t\t\t\t\t\t\t\t\tname=\"userPswd\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\ttype=\"text\" class=\"form-control\" id=\"exampleInputPassword1\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tplaceholder=\"请输入登录密码\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<label for=\"exampleInputPassword1\">用户昵称</label> \r\n");
      out.write("\t\t\t\t\t\t\t\t<input\r\n");
      out.write("\t\t\t\t\t\t\t\t\tname=\"userName\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\ttype=\"text\" class=\"form-control\" id=\"exampleInputPassword1\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tplaceholder=\"请输入用户昵称\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
